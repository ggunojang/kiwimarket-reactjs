...
import { getList } from "../../../api/market_comment";
import { formatDate } from "../../../utils/common";

export default function CommentList({ market_id = 0 }) {
  ...
  } = useContext(MarketCommentContext);
  ...
  useEffect(() => {
    ...
    const fetchCategory = async () => {
      try {
        ...
        const data = await getList(market_id, currentPage);
  ...
  }, [currentPage, market_id, dispatch, newComments]);
            ...
            <div className="flow-root">
              <div className="my-3 divide-y divide-gray-200">
                {commentData.list.map((comment) => (
                  <div key={comment.mct_id} className="py-8">
